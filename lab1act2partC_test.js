...
console.log(pc.calc('{"op" : "add", "number" : 0}')); // should return 0
console.log(pc.calc('{"op" : "add", "number" : -1}')); // should return -1
console.log(pc.calc('{"op" : "subtract", "number" : -1}')); // should return 0
console.log(pc.calc('{"op" : "add", "number" : 5}')); // should return 5
console.log(pc.calc('{"op" : "subtract", "number" : 10}')); // should return -5
console.log(pc.calc('{"op" : "add", "number" : 15}')); // should return 10
console.log(pc.calc('{"op": "subtract", "expr" : {"op" : "add", "number" : 15}}')); // should return 0
